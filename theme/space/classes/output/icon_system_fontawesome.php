...
class icon_system_fontawesome extends \core\output\icon_system_fontawesome {
    ...
    public function get_core_icon_map() {
        ...
        //support for https://moodle.org/plugins/local_pages
        ...
        $iconmap['local_pages:docs'] = 'fas fa-info-circle';
        $iconmap['local_pages:help'] = 'fas fa-question-circle text-info';
        $iconmap['local_pages:req'] = 'fas fa-exclamation-circle text-danger';
        $iconmap['local_pages:a/add_file'] = 'fas fa-file-o';
        $iconmap['local_pages:a/create_folder'] = 'fas fa-folder-o';
        $iconmap['local_pages:a/download_all'] = 'fas fa-download';
        $iconmap['local_pages:a/help'] = 'fas fa-question-circle text-info';
        $iconmap['local_pages:a/logout'] = 'fas fa-sign-out';
        $iconmap['local_pages:a/refresh'] = 'fas fa-refresh';
        $iconmap['local_pages:a/search'] = 'fas fa-search';
        $iconmap['local_pages:a/setting'] = 'fas fa-cog';
        $iconmap['local_pages:a/view_icon_active'] = 'fas fa-th';
        $iconmap['local_pages:a/view_list_active'] = 'fas fa-list';
        $iconmap['local_pages:a/view_tree_active'] = 'fas fa-folder';
        $iconmap['local_pages:b/bookmark-new'] = 'fas fa-bookmark';
        $iconmap['local_pages:b/document-edit'] = 'fas fa-pencil';
        $iconmap['local_pages:b/document-new'] = 'fas fa-file-o';
        $iconmap['local_pages:b/document-properties'] = 'fas fa-info';
        $iconmap['local_pages:b/edit-copy'] = 'fas fa-files-o';
        $iconmap['local_pages:b/edit-delete'] = 'fas fa-trash';
        $iconmap['local_pages:e/abbr'] = 'fas fa-comment';
        $iconmap['local_pages:e/absolute'] = 'fas fa-crosshairs';
        $iconmap['local_pages:e/accessibility_checker'] = 'fas fa-universal-access';
        $iconmap['local_pages:e/acronym'] = 'fas fa-comment';
        $iconmap['local_pages:e/advance_hr'] = 'fas fa-arrows-h';
        $iconmap['local_pages:e/align_center'] = 'fas fa-align-center';
        $iconmap['local_pages:e/align_left'] = 'fas fa-align-left';
        $iconmap['local_pages:e/align_right'] = 'fas fa-align-right';
        $iconmap['local_pages:e/anchor'] = 'fas fa-chain';
        $iconmap['local_pages:e/backward'] = 'fas fa-undo';
        $iconmap['local_pages:e/bold'] = 'fas fa-bold';
        $iconmap['local_pages:e/bullet_list'] = 'fas fa-list-ul';
        $iconmap['local_pages:e/cancel'] = 'fas fa-times';
        $iconmap['local_pages:e/cell_props'] = 'fas fa-info';
        $iconmap['local_pages:e/cite'] = 'fas fa-quote-right';
        $iconmap['local_pages:e/cleanup_messy_code'] = 'fas fa-eraser';
        $iconmap['local_pages:e/clear_formatting'] = 'fas fa-i-cursor';
        $iconmap['local_pages:e/copy'] = 'fas fa-clone';
        $iconmap['local_pages:e/cut'] = 'fas fa-scissors';
        $iconmap['local_pages:e/decrease_indent'] = 'fas fa-outdent';
        $iconmap['local_pages:e/delete_col'] = 'fas fa-minus';
        $iconmap['local_pages:e/delete_row'] = 'fas fa-minus';
        $iconmap['local_pages:e/delete'] = 'fas fa-minus';
        $iconmap['local_pages:e/delete_table'] = 'fas fa-minus';
        $iconmap['local_pages:e/document_properties'] = 'fas fa-info';
        $iconmap['local_pages:e/emoticons'] = 'fas fa-smile-o';
        $iconmap['local_pages:e/find_replace'] = 'fas fa-search-plus';
        $iconmap['local_pages:e/file-text'] = 'fas fa-file-text';
        $iconmap['local_pages:e/forward'] = 'fas fa-arrow-right';
        $iconmap['local_pages:e/fullpage'] = 'fas fa-arrows-alt';
        $iconmap['local_pages:e/fullscreen'] = 'fas fa-arrows-alt';
        $iconmap['local_pages:e/help'] = 'fas fa-question-circle';
        $iconmap['local_pages:e/increase_indent'] = 'fas fa-indent';
        $iconmap['local_pages:e/insert_col_after'] = 'fas fa-columns';
        $iconmap['local_pages:e/insert_col_before'] = 'fas fa-columns';
        $iconmap['local_pages:e/insert_date'] = 'fas fa-calendar';
        $iconmap['local_pages:e/insert_edit_image'] = 'fas fa-picture-o';
        $iconmap['local_pages:e/insert_edit_link'] = 'fas fa-link';
        $iconmap['local_pages:e/insert_edit_video'] = 'fas fa-file-video-o';
        $iconmap['local_pages:e/insert_file'] = 'fas fa-file';
        $iconmap['local_pages:e/insert_horizontal_ruler'] = 'fas fa-arrows-h';
        $iconmap['local_pages:e/insert_nonbreaking_space'] = 'fas fa-square-o';
        $iconmap['local_pages:e/insert_page_break'] = 'fas fa-level-down';
        $iconmap['local_pages:e/insert_row_after'] = 'fas fa-plus';
        $iconmap['local_pages:e/insert_row_before'] = 'fas fa-plus';
        $iconmap['local_pages:e/insert'] = 'fas fa-plus';
        $iconmap['local_pages:e/insert_time'] = 'fas fa-clock-o';
        $iconmap['local_pages:e/italic'] = 'fas fa-italic';
        $iconmap['local_pages:e/justify'] = 'fas fa-align-justify';
        $iconmap['local_pages:e/layers_over'] = 'fas fa-level-up';
        $iconmap['local_pages:e/layers'] = 'fas fa-window-restore';
        $iconmap['local_pages:e/layers_under'] = 'fas fa-level-down';
        $iconmap['local_pages:e/left_to_right'] = 'fas fa-chevron-right';
        $iconmap['local_pages:e/manage_files'] = 'fas fa-files-o';
        $iconmap['local_pages:e/math'] = 'fas fa-calculator';
        $iconmap['local_pages:e/merge_cells'] = 'fas fa-compress';
        $iconmap['local_pages:e/new_document'] = 'fas fa-file-o';
        $iconmap['local_pages:e/numbered_list'] = 'fas fa-list-ol';
        $iconmap['local_pages:e/page_break'] = 'fas fa-level-down';
        $iconmap['local_pages:e/paste'] = 'fas fa-clipboard';
        $iconmap['local_pages:e/paste_text'] = 'fas fa-clipboard';
        $iconmap['local_pages:e/paste_word'] = 'fas fa-clipboard';
        $iconmap['local_pages:e/prevent_autolink'] = 'fas fa-exclamation';
        $iconmap['local_pages:e/preview'] = 'fas fa-search-plus';
        $iconmap['local_pages:e/print'] = 'fas fa-print';
        $iconmap['local_pages:e/question'] = 'fas fa-question';
        $iconmap['local_pages:e/redo'] = 'fas fa-repeat';
        $iconmap['local_pages:e/remove_link'] = 'fas fa-chain-broken';
        $iconmap['local_pages:e/remove_page_break'] = 'fas fa-remove';
        $iconmap['local_pages:e/resize'] = 'fas fa-expand';
        $iconmap['local_pages:e/restore_draft'] = 'fas fa-undo';
        $iconmap['local_pages:e/restore_last_draft'] = 'fas fa-undo';
        $iconmap['local_pages:e/right_to_left'] = 'fas fa-chevron-left';
        $iconmap['local_pages:e/row_props'] = 'fas fa-info';
        $iconmap['local_pages:e/save'] = 'fas fa-floppy-o';
        $iconmap['local_pages:e/screenreader_helper'] = 'fas fa-braille';
        $iconmap['local_pages:e/search'] = 'fas fa-search';
        $iconmap['local_pages:e/select_all'] = 'fas fa-arrows-h';
        $iconmap['local_pages:e/show_invisible_characters'] = 'fas fa-eye-slash';
        $iconmap['local_pages:e/source_code'] = 'fas fa-code';
        $iconmap['local_pages:e/special_character'] = 'fas fa-pencil-square-o';
        $iconmap['local_pages:e/spellcheck'] = 'fas fa-check';
        $iconmap['local_pages:e/split_cells'] = 'fas fa-columns';
        $iconmap['local_pages:e/strikethrough'] = 'fas fa-strikethrough';
        $iconmap['local_pages:e/styleparagraph'] = 'fas fa-font';
        $iconmap['local_pages:e/subscript'] = 'fas fa-subscript';
        $iconmap['local_pages:e/superscript'] = 'fas fa-superscript';
        $iconmap['local_pages:e/table_props'] = 'fas fa-table';
        $iconmap['local_pages:e/table'] = 'fas fa-table';
        $iconmap['local_pages:e/template'] = 'fas fa-sticky-note';
        $iconmap['local_pages:e/text_color_picker'] = 'fas fa-paint-brush';
        $iconmap['local_pages:e/text_color'] = 'fas fa-paint-brush';
        $iconmap['local_pages:e/text_highlight_picker'] = 'fas fa-lightbulb-o';
        $iconmap['local_pages:e/text_highlight'] = 'fas fa-lightbulb-o';
        $iconmap['local_pages:e/tick'] = 'fas fa-check';
        $iconmap['local_pages:e/toggle_blockquote'] = 'fas fa-quote-left';
        $iconmap['local_pages:e/underline'] = 'fas fa-underline';
        $iconmap['local_pages:e/undo'] = 'fas fa-undo';
        $iconmap['local_pages:e/visual_aid'] = 'fas fa-universal-access';
        $iconmap['local_pages:e/visual_blocks'] = 'fas fa-audio-description';
        $iconmap['local_pages:i/addblock'] = 'fas fa-plus-square';
        $iconmap['local_pages:i/assignroles'] = 'fas fa-user-plus';
        $iconmap['local_pages:i/backup'] = 'fas fa-file-zip-o';
        $iconmap['local_pages:i/badge'] = 'fas fa-shield';
        $iconmap['local_pages:i/calc'] = 'fas fa-calculator';
        $iconmap['local_pages:i/calendar'] = 'fas fa-calendar';
        $iconmap['local_pages:i/calendareventdescription'] = 'fas fa-align-left';
        $iconmap['local_pages:i/calendareventtime'] = 'fas fa-clock-o';
        $iconmap['local_pages:i/caution'] = 'fas fa-exclamation text-warning';
        $iconmap['local_pages:i/checked'] = 'fas fa-check';
        $iconmap['local_pages:i/checkedcircle'] = 'fas fa-check-circle';
        $iconmap['local_pages:i/checkpermissions'] = 'fas fa-unlock-alt';
        $iconmap['local_pages:i/cohort'] = 'fas fa-users';
        $iconmap['local_pages:i/competencies'] = 'fas fa-check-square-o';
        $iconmap['local_pages:i/completion_self'] = 'fas fa-user-o';
        $iconmap['local_pages:i/dashboard'] = 'fas fa-tachometer';
        $iconmap['local_pages:i/lock'] = 'fas fa-lock';
        $iconmap['local_pages:i/categoryevent'] = 'fas fa-cubes';
        $iconmap['local_pages:i/course'] = 'fas fa-graduation-cap';
        $iconmap['local_pages:i/courseevent'] = 'fas fa-graduation-cap';
        $iconmap['local_pages:i/customfield'] = 'fas fa-hand-o-right';
        $iconmap['local_pages:i/db'] = 'fas fa-database';
        $iconmap['local_pages:i/delete'] = 'fas fa-trash';
        $iconmap['local_pages:i/down'] = 'fas fa-arrow-down';
        $iconmap['local_pages:i/dragdrop'] = 'fas fa-arrows';
        $iconmap['local_pages:i/duration'] = 'fas fa-clock-o';
        $iconmap['local_pages:i/edit'] = 'fas fa-pencil';
        $iconmap['local_pages:i/email'] = 'fas fa-envelope';
        $iconmap['local_pages:i/empty'] = 'fas fa-fw';
        $iconmap['local_pages:i/enrolmentsuspended'] = 'fas fa-pause';
        $iconmap['local_pages:i/enrolusers'] = 'fas fa-user-plus';
        $iconmap['local_pages:i/expired'] = 'fas fa-exclamation text-warning';
        $iconmap['local_pages:i/export'] = 'fas fa-download';
        $iconmap['local_pages:i/files'] = 'fas fa-file';
        $iconmap['local_pages:i/filter'] = 'fas fa-filter';
        $iconmap['local_pages:i/flagged'] = 'fas fa-flag';
        $iconmap['local_pages:i/folder'] = 'fas fa-folder';
        $iconmap['local_pages:i/grade_correct'] = 'fas fa-check text-success';
        $iconmap['local_pages:i/grade_incorrect'] = 'fas fa-remove text-danger';
        $iconmap['local_pages:i/grade_partiallycorrect'] = 'fas fa-check-square';
        $iconmap['local_pages:i/grades'] = 'fas fa-table';
        $iconmap['local_pages:i/groupevent'] = 'fas fa-group';
        $iconmap['local_pages:i/groupn'] = 'fas fa-user';
        $iconmap['local_pages:i/group'] = 'fas fa-users';
        $iconmap['local_pages:i/groups'] = 'fas fa-user-circle';
        $iconmap['local_pages:i/groupv'] = 'fas fa-user-circle-o';
        $iconmap['local_pages:i/home'] = 'fas fa-home';
        $iconmap['local_pages:i/hide'] = 'fas fa-eye';
        $iconmap['local_pages:i/hierarchylock'] = 'fas fa-lock';
        $iconmap['local_pages:i/import'] = 'fas fa-level-up';
        $iconmap['local_pages:i/incorrect'] = 'fas fa-exclamation';
        $iconmap['local_pages:i/info'] = 'fas fa-info';
        $iconmap['local_pages:i/invalid'] = 'fas fa-times text-danger';
        $iconmap['local_pages:i/item'] = 'fas fa-circle';
        $iconmap['local_pages:i/loading'] = 'fas fa-circle-o-notch fa-spin';
        $iconmap['local_pages:i/loading_small'] = 'fas fa-circle-o-notch fa-spin';
        $iconmap['local_pages:i/location'] = 'fas fa-map-marker';
        $iconmap['local_pages:i/lock'] = 'fas fa-lock';
        $iconmap['local_pages:i/log'] = 'fas fa-list-alt';
        $iconmap['local_pages:i/mahara_host'] = 'fas fa-id-badge';
        $iconmap['local_pages:i/manual_item'] = 'fas fa-square-o';
        $iconmap['local_pages:i/marked'] = 'fas fa-circle';
        $iconmap['local_pages:i/marker'] = 'fas fa-circle-o';
        $iconmap['local_pages:i/mean'] = 'fas fa-calculator';
        $iconmap['local_pages:i/menu'] = 'fas fa-ellipsis-v';
        $iconmap['local_pages:i/menubars'] = 'fas fa-bars';
        $iconmap['local_pages:i/messagecontentaudio'] = 'fas fa-headphones';
        $iconmap['local_pages:i/messagecontentimage'] = 'fas fa-image';
        $iconmap['local_pages:i/messagecontentvideo'] = 'fas fa-film';
        $iconmap['local_pages:i/messagecontentmultimediageneral'] = 'fas fa-file-video-o';
        $iconmap['local_pages:i/mnethost'] = 'fas fa-external-link';
        $iconmap['local_pages:i/moodle_host'] = 'fas fa-graduation-cap';
        $iconmap['local_pages:i/moremenu'] = 'fas fa-ellipsis-h';
        $iconmap['local_pages:i/move_2d'] = 'fas fa-arrows';
        $iconmap['local_pages:i/muted'] = 'fas fa-microphone-slash';
        $iconmap['local_pages:i/navigationitem'] = 'fas fa-fw';
        $iconmap['local_pages:i/ne_red_mark'] = 'fas fa-remove';
        $iconmap['local_pages:i/new'] = 'fas fa-bolt';
        $iconmap['local_pages:i/news'] = 'fas fa-newspaper-o';
        $iconmap['local_pages:i/next'] = 'fas fa-chevron-right';
        $iconmap['local_pages:i/nosubcat'] = 'fas fa-plus-square-o';
        $iconmap['local_pages:i/notifications'] = 'fas fa-bell';
        $iconmap['local_pages:i/open'] = 'fas fa-folder-open';
        $iconmap['local_pages:i/outcomes'] = 'fas fa-tasks';
        $iconmap['local_pages:i/payment'] = 'fas fa-money';
        $iconmap['local_pages:i/permissionlock'] = 'fas fa-lock';
        $iconmap['local_pages:i/permissions'] = 'fas fa-pencil-square-o';
        $iconmap['local_pages:i/persona_sign_in_black'] = 'fas fa-male';
        $iconmap['local_pages:i/portfolio'] = 'fas fa-id-badge';
        $iconmap['local_pages:i/preview'] = 'fas fa-search-plus';
        $iconmap['local_pages:i/previous'] = 'fas fa-chevron-left';
        $iconmap['local_pages:i/privatefiles'] = 'fas fa-file-o';
        $iconmap['local_pages:i/progressbar'] = 'fas fa-spinner fa-spin';
        $iconmap['local_pages:i/publish'] = 'fas fa-share';
        $iconmap['local_pages:i/questions'] = 'fas fa-question';
        $iconmap['local_pages:i/reload'] = 'fas fa-refresh';
        $iconmap['local_pages:i/report'] = 'fas fa-area-chart';
        $iconmap['local_pages:i/repository'] = 'fas fa-hdd-o';
        $iconmap['local_pages:i/restore'] = 'fas fa-level-up';
        $iconmap['local_pages:i/return'] = 'fas fa-arrow-left';
        $iconmap['local_pages:i/risk_config'] = 'fas fa-exclamation text-muted';
        $iconmap['local_pages:i/risk_managetrust'] = 'fas fa-exclamation-triangle text-warning';
        $iconmap['local_pages:i/risk_personal'] = 'fas fa-exclamation-circle text-info';
        $iconmap['local_pages:i/risk_spam'] = 'fas fa-exclamation text-primary';
        $iconmap['local_pages:i/risk_xss'] = 'fas fa-exclamation-triangle text-danger';
        $iconmap['local_pages:i/role'] = 'fas fa-user-md';
        $iconmap['local_pages:i/rss'] = 'fas fa-rss';
        $iconmap['local_pages:i/rsssitelogo'] = 'fas fa-graduation-cap';
        $iconmap['local_pages:i/scales'] = 'fas fa-balance-scale';
        $iconmap['local_pages:i/scheduled'] = 'fas fa-calendar-check-o';
        $iconmap['local_pages:i/search'] = 'fas fa-search';
        $iconmap['local_pages:i/section'] = 'fas fa-folder-o';
        $iconmap['local_pages:i/sendmessage'] = 'fas fa-paper-plane';
        $iconmap['local_pages:i/settings'] = 'fas fa-cog';
        $iconmap['local_pages:i/show'] = 'fas fa-eye-slash';
        $iconmap['local_pages:i/siteevent'] = 'fas fa-globe';
        $iconmap['local_pages:i/star'] = 'fas fa-star';
        $iconmap['local_pages:i/star-rating'] = 'fas fa-star';
        $iconmap['local_pages:i/stats'] = 'fas fa-line-chart';
        $iconmap['local_pages:i/switch'] = 'fas fa-exchange';
        $iconmap['local_pages:i/switchrole'] = 'fas fa-user-secret';
        $iconmap['local_pages:i/trash'] = 'fas fa-trash';
        $iconmap['local_pages:i/twoway'] = 'fas fa-arrows-h';
        $iconmap['local_pages:i/unchecked'] = 'fas fa-square-o';
        $iconmap['local_pages:i/uncheckedcircle'] = 'fas fa-circle-o';
        $iconmap['local_pages:i/unflagged'] = 'fas fa-flag-o';
        $iconmap['local_pages:i/unlock'] = 'fas fa-unlock';
        $iconmap['local_pages:i/up'] = 'fas fa-arrow-up';
        $iconmap['local_pages:i/userevent'] = 'fas fa-user';
        $iconmap['local_pages:i/user'] = 'fas fa-user';
        $iconmap['local_pages:i/users'] = 'fas fa-users';
        $iconmap['local_pages:i/valid'] = 'fas fa-check text-success';
        $iconmap['local_pages:i/warning'] = 'fas fa-exclamation text-warning';
        $iconmap['local_pages:i/window_close'] = 'fas fa-window-close';
        $iconmap['local_pages:i/withsubcat'] = 'fas fa-plus-square';
        $iconmap['local_pages:m/USD'] = 'fas fa-usd';
        $iconmap['local_pages:t/addcontact'] = 'fas fa-address-card';
        $iconmap['local_pages:t/add'] = 'fas fa-plus';
        $iconmap['local_pages:t/approve'] = 'fas fa-thumbs-up';
        $iconmap['local_pages:t/assignroles'] = 'fas fa-user-circle';
        $iconmap['local_pages:t/award'] = 'fas fa-trophy';
        $iconmap['local_pages:t/backpack'] = 'fas fa-shopping-bag';
        $iconmap['local_pages:t/backup'] = 'fas fa-arrow-circle-down';
        $iconmap['local_pages:t/block'] = 'fas fa-ban';
        $iconmap['local_pages:t/block_to_dock_rtl'] = 'fas fa-chevron-right';
        $iconmap['local_pages:t/block_to_dock'] = 'fas fa-chevron-left';
        $iconmap['local_pages:t/calc_off'] = 'fas fa-calculator'; // TODO: Change to better icon once we have stacked icon support or more icons.
        $iconmap['local_pages:t/calc'] = 'fas fa-calculator';
        $iconmap['local_pages:t/check'] = 'fas fa-check';
        $iconmap['local_pages:t/cohort'] = 'fas fa-users';
        $iconmap['local_pages:t/collapsed_empty_rtl'] = 'fas fa-caret-square-o-left';
        $iconmap['local_pages:t/collapsed_empty'] = 'fas fa-caret-square-o-right';
        $iconmap['local_pages:t/collapsed_rtl'] = 'fas fa-caret-left';
        $iconmap['local_pages:t/collapsed'] = 'fas fa-caret-right';
        $iconmap['local_pages:t/collapsedcaret'] = 'fas fa-caret-right';
        $iconmap['local_pages:t/contextmenu'] = 'fas fa-cog';
        $iconmap['local_pages:t/copy'] = 'fas fa-copy';
        $iconmap['local_pages:t/delete'] = 'fas fa-trash';
        $iconmap['local_pages:t/dockclose'] = 'fas fa-window-close';
        $iconmap['local_pages:t/dock_to_block_rtl'] = 'fas fa-chevron-right';
        $iconmap['local_pages:t/dock_to_block'] = 'fas fa-chevron-left';
        $iconmap['local_pages:t/download'] = 'fas fa-download';
        $iconmap['local_pages:t/down'] = 'fas fa-arrow-down';
        $iconmap['local_pages:t/downlong'] = 'fas fa-long-arrow-down';
        $iconmap['local_pages:t/dropdown'] = 'fas fa-cog';
        $iconmap['local_pages:t/editinline'] = 'fas fa-pencil';
        $iconmap['local_pages:t/edit_menu'] = 'fas fa-cog';
        $iconmap['local_pages:t/editstring'] = 'fas fa-pencil';
        $iconmap['local_pages:t/edit'] = 'fas fa-cog';
        $iconmap['local_pages:t/emailno'] = 'fas fa-ban';
        $iconmap['local_pages:t/email'] = 'fas fa-envelope-o';
        $iconmap['local_pages:t/emptystar'] = 'fas fa-star-o';
        $iconmap['local_pages:t/enrolusers'] = 'fas fa-user-plus';
        $iconmap['local_pages:t/expanded'] = 'fas fa-caret-down';
        $iconmap['local_pages:t/go'] = 'fas fa-play';
        $iconmap['local_pages:t/grades'] = 'fas fa-table';
        $iconmap['local_pages:t/groupn'] = 'fas fa-user';
        $iconmap['local_pages:t/groups'] = 'fas fa-user-circle';
        $iconmap['local_pages:t/groupv'] = 'fas fa-user-circle-o';
        $iconmap['local_pages:t/hide'] = 'fas fa-eye';
        $iconmap['local_pages:t/left'] = 'fas fa-arrow-left';
        $iconmap['local_pages:t/less'] = 'fas fa-caret-up';
        $iconmap['local_pages:t/locked'] = 'fas fa-lock';
        $iconmap['local_pages:t/lock'] = 'fas fa-unlock';
        $iconmap['local_pages:t/locktime'] = 'fas fa-lock';
        $iconmap['local_pages:t/markasread'] = 'fas fa-check';
        $iconmap['local_pages:t/messages'] = 'fas fa-comments';
        $iconmap['local_pages:t/message'] = 'fas fa-comment';
        $iconmap['local_pages:t/more'] = 'fas fa-caret-down';
        $iconmap['local_pages:t/move'] = 'fas fa-arrows-v';
        $iconmap['local_pages:t/online'] = 'fas fa-circle';
        $iconmap['local_pages:t/passwordunmask-edit'] = 'fas fa-pencil';
        $iconmap['local_pages:t/passwordunmask-reveal'] = 'fas fa-eye';
        $iconmap['local_pages:t/portfolioadd'] = 'fas fa-plus';
        $iconmap['local_pages:t/preferences'] = 'fas fa-wrench';
        $iconmap['local_pages:t/preview'] = 'fas fa-search-plus';
        $iconmap['local_pages:t/print'] = 'fas fa-print';
        $iconmap['local_pages:t/removecontact'] = 'fas fa-user-times';
        $iconmap['local_pages:t/reload'] = 'fas fa-refresh';
        $iconmap['local_pages:t/reset'] = 'fas fa-repeat';
        $iconmap['local_pages:t/restore'] = 'fas fa-arrow-circle-up';
        $iconmap['local_pages:t/right'] = 'fas fa-arrow-right';
        $iconmap['local_pages:t/sendmessage'] = 'fas fa-paper-plane';
        $iconmap['local_pages:t/show'] = 'fas fa-eye-slash';
        $iconmap['local_pages:t/sort_by'] = 'fas fa-sort-amount-asc';
        $iconmap['local_pages:t/sort_asc'] = 'fas fa-sort-asc';
        $iconmap['local_pages:t/sort_desc'] = 'fas fa-sort-desc';
        $iconmap['local_pages:t/sort'] = 'fas fa-sort';
        $iconmap['local_pages:t/stop'] = 'fas fa-stop';
        $iconmap['local_pages:t/switch_minus'] = 'fas fa-minus';
        $iconmap['local_pages:t/switch_plus'] = 'fas fa-plus';
        $iconmap['local_pages:t/switch_whole'] = 'fas fa-square-o';
        $iconmap['local_pages:t/tags'] = 'fas fa-tags';
        $iconmap['local_pages:t/unblock'] = 'fas fa-commenting';
        $iconmap['local_pages:t/unlocked'] = 'fas fa-unlock-alt';
        $iconmap['local_pages:t/unlock'] = 'fas fa-lock';
        $iconmap['local_pages:t/up'] = 'fas fa-arrow-up';
        $iconmap['local_pages:t/uplong'] = 'fas fa-long-arrow-up';
        $iconmap['local_pages:t/user'] = 'fas fa-user';
