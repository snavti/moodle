...
class theme_space_core_question_renderer extends core_question_renderer {
    ...
    protected function info(question_attempt $qa, qbehaviour_renderer $behaviouroutput,
        ...
        $output = '';
        $output .= '<div class="d-inline-flex align-items-center flex-wrap">' .$this->number($number) . '<div class="d-inline-flex align-items-center flex-wrap">' . $this->status($qa, $behaviouroutput, $options) . $this->mark_summary($qa, $behaviouroutput, $options) . '</div></div>';
...
class theme_space_qtype_multichoice_single_renderer extends qtype_multichoice_single_renderer  {
