...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'stripesubscription'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/stripesubscription/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_stripesubscription', format_string($course->fullname));
