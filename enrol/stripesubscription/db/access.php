...
$capabilities = array(
    ...
    'enrol/stripesubscription:config' => array(
        'captype' => 'write',
    ...
    'enrol/stripesubscription:manage' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/stripesubscription:unenrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/stripesubscription:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
        )
