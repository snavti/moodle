 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_stripesubscription_plugin extends enrol_plugin {
    /**
     * Get actual stripe amount.
     *
     * @param string $cost
    ...
    public function get_stripe_amount($cost, $currency, $reverse) {
        $nodecimalcurrencies = array("bif", "clp", "djf", "gnf", "jpy", "kmf", "krw",
    ...
    public function get_currencies() {
        ...
        $codes = array(
            ...
            'AWG', 'AZN', 'BAM', 'BBD', 'BDT', 'BGN', 'BMD', 'BND', 'BOB',
            'BRL', 'BSD', 'BWP', 'BZD', 'CAD', 'CDF', 'CHF', 'CNY', 'COP',
            'CRC', 'CVE', 'CZK', 'DKK', 'DOP', 'DZD', 'EGP', 'ETB', 'EUR',
            'FJD', 'GBP', 'GEL', 'GIP', 'GMD', 'GTQ', 'GYD', 'HKD', 'HNL',
            'HRK', 'HTG', 'HUF', 'IDR', 'ILS', 'INR', 'ISK', 'JMD', 'KES',
            'KGS', 'KHR', 'KYD', 'KZT', 'LAK', 'LBP', 'LKR', 'LRD', 'LSL',
            'MAD', 'MDL', 'MKD', 'MMK', 'MNT', 'MOP', 'MRO', 'MUR', 'MVR',
            'MWK', 'MXN', 'MYR', 'MZN', 'NAD', 'NGN', 'NIO', 'NOK', 'NPR',
            'NZD', 'PAB', 'PEN', 'PGK', 'PHP', 'PKR', 'PLN', 'QAR', 'RON',
            'RSD', 'RUB', 'SAR', 'SBD', 'SCR', 'SEK', 'SGD', 'SHP', 'SLL',
            'SOS', 'SRD', 'STD', 'SZL', 'THB', 'TJS', 'TOP', 'TRY', 'TTD',
    ...
    public function get_info_icons(array $instances) {
        ...
        if ($found) {
            return array(new pix_icon('icon', get_string('pluginname', 'enrol_stripesubscription'), 'enrol_stripesubscription'));
        }
        return array();
    }
    /**
    ...
    public function add_course_navigation($instancesnode, stdClass $instance) {
        if ($instance->enrol !== 'stripesubscription') {
            throw new coding_exception('Invalid enrol instance type!');
        }

        $context = context_course::instance($instance->courseid);
        if (has_capability('enrol/stripesubscription:config', $context)) {
            $managelink = new moodle_url('/enrol/stripesubscription/edit.php',
    ...
    public function get_action_icons(stdClass $instance) {
        ...
        if (has_capability('enrol/stripesubscription:config', $context)) {
            $editlink = new moodle_url("/enrol/stripesubscription/edit.php",
                array('courseid' => $instance->courseid, 'id' => $instance->id));
    ...
    public function get_newinstance_link($courseid) {
        ...
        if (!has_capability('moodle/course:enrolconfig', $context) or
         !has_capability('enrol/stripesubscription:config', $context)) {
            return null;
        }

        // Multiple instances supported - different cost for different roles.
        return new moodle_url('/enrol/stripesubscription/edit.php', array('courseid' => $courseid));
    }
    ...
    public function enrol_page_hook(stdClass $instance) {
        ...
        $enrolstatus = $this->can_stripesubscription_enrol($instance);

        if (!$enrolstatus) {
            return get_string('maxenrolledreached', 'enrol_stripesubscription');
        }
        ...
        if (abs($cost) < 0.01) { // No cost, other enrolment methods (instances) should be used.
            echo '<p>'.get_string('nocost', 'enrol_stripesubscription').'</p>';
        } else {
            ...
            if (isguestuser()) { // Force login only for guest user, not real users with guest role.
                ...
                include($CFG->dirroot.'/enrol/stripesubscription/enrol.php');
            }
     ...
     * @return string html text, usually a form in a text box
     */
    public function can_stripesubscription_enrol(stdClass $instance) {
        ...
        if ($instance->customint3 > 0) {
            ...
            if ($count >= $instance->customint3) {
                // Bad luck, no more stripesubscription enrolments here.
                return false;
            }
        }
        return true;
    ...
    public function restore_instance(restore_enrolments_structure_step $step, stdClass $data, $course, $oldid) {
        ...
        if ($step->get_task()->get_target() == backup::TARGET_NEW_COURSE) {
            ...
            $merge = array(
                ...
                'customchar1' => $data->freetrialduration,
                'customchar2' => $data->subscriptioninterval,
                'customchar3' => $data->stripecoupon,
            );
        }
    ...
    public function get_user_enrolment_actions(course_enrolment_manager $manager, $ue) {
        ...
        $params['ue'] = $ue->id;
        if ($this->allow_unenrol($instance) && has_capability("enrol/stripesubscription:unenrol", $context)) {
        ...
        if ($this->allow_manage($instance) && has_capability("enrol/stripesubscription:manage", $context)) {
    ...
    public function can_delete_instance($instance) {
        $context = context_course::instance($instance->courseid);
        return has_capability('enrol/stripesubscription:config', $context);
    }
