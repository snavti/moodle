...
$answer = get_string("stripecouponerror", "enrol_stripesubscription");
...
$plugininstance = $DB->get_record("enrol", array("enrol" => 'stripesubscription', "status" => 0, 'courseid' => $courseid));
