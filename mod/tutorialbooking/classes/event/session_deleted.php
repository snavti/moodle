...
class session_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has deleted a session with id '$this->objectid' from the tutorial "
    ...
    public static function get_name() {
        return get_string('eventsessiondeleted', 'mod_tutorialbooking');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'tutorialbooking', 'deletesession', $logurl, 'Session: ' . $this->objectid, $this->contextinstanceid);
    }
