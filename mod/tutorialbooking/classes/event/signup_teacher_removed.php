 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class signup_teacher_removed extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has revoked the signup for the user with id '$this->relateduserid' to a "
                . "session with id '{$this->other['sessionid']}' of the tutorial booking activity with "
                . "id '{$this->other['tutorialid']}' in the course with id '$this->courseid'.";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'tutorialbooking', 'remove signup', $logurl, $message, $this->contextinstanceid);
    }
