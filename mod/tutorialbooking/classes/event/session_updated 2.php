...
class session_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated a session with id '$this->objectid' in the tutorial "
    ...
    public static function get_name() {
        return get_string('eventsessionupdated', 'mod_tutorialbooking');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'tutorialbooking', 'updatesession', $logurl, 'Session: ' . $this->objectid, $this->contextinstanceid);
    }
