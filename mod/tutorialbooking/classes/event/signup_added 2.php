 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class signup_added extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has signed up to a session with id '{$this->other['sessionid']}' of the tutorial "
    ...
    public static function get_name() {
        return get_string('eventsignupadded', 'mod_tutorialbooking');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/tutorialbooking/view.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $message = "{$this->other['tutorialname']} ({$this->other['tutorialid']}), Session: {$this->other['sessionid']}";
        return array($this->courseid, 'tutorialbooking', 'signup', $logurl, $message, $this->contextinstanceid);
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['tutorialname'])) {
            throw new \coding_exception('The \'tutorialname\' value must be set in other.');
        }
