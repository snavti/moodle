 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class signup_removed extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has removed their signup to a session with id '$this->objectid' of the tutorial "
    ...
    public static function get_name() {
        return get_string('eventsignupremoved', 'mod_tutorialbooking');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/tutorialbooking/view.php',
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'tutorialbooking', 'unsignup', $logurl, $message, $this->contextinstanceid);
    }
