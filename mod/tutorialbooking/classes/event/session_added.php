...
class session_added extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has added a session with id '$this->objectid' to the tutorial "
    ...
    public static function get_name() {
        return get_string('eventsessionadded', 'mod_tutorialbooking');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'tutorialbooking', 'addsession', $logurl, 'Session: ' . $this->objectid, $this->contextinstanceid);
    }
